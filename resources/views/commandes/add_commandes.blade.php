                        ...
                        <div class="row align-items-center g-3 mb-3">
                            <div class="col-md-3">
                                <div class="autocomplete-container">
                                    <input type="text" id="nom_produit0" name="nom_produit0" class="form-control" placeholder="Entrer un nom de produit" onkeyup="autoCompletion_produits(0)" />
                            ...
                            <div class="col-md-3">
                                <input type="number" id="prix_unitaire0" name="prix_unitaire0" class="form-control" placeholder="entrer un prix de produit" readonly />
                            </div>
                            <div class="col-md-3">
