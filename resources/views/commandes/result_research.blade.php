                                    ...
                                    <table class="table select-table">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <button class="btn btn-success" data-id="{{$commande->id}}" data-nom="{{$commande->nom_client}}" data-total_achat="{{$commande->total_achat}}" data-montant_paye="{{$commande->montant_paye}}" data-moyen_paiement="{{$commande->moyen_paiement}}" data-reste="{{$commande->reste}}" onclick="open"> modifier </button>
                                              <button class="btn btn-danger text-white" data-id="{{$commande->id}}" onclick="openDeleteModal(this)" > supprimer </button>
                                              <a href="/imprimer_pdf/{{$commande->id}}" class="btn btn-success"> imprimer </a>
                                            </td>
                                          </tr>
                                        @endforeach
                                      </tbody>
